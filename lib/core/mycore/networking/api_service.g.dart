...
class _ApiService implements ApiService {
  ...
  @override
  Future<GetPlacesResponse> getAllPlaces(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetPlacesResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetPlacesResponse _value;
    try {
      _value = GetPlacesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetNearestPlacesResponse> getNearestPlaces(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetNearestPlacesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'place/near',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetNearestPlacesResponse _value;
    try {
      _value = GetNearestPlacesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
